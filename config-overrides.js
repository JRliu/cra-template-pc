...
const overrideList = [
    setWebpackPublicPath(isPrd ? `${'https://qn.lauginwing.top/'}` : '/'),
...
if (isPrd) {
    // 打包资源缓存，大大提高打包速度
    overrideList.push(addWebpackPlugin(new HardSourceWebpackPlugin()));
} else {
    // react-dev-inspector
    overrideList.push(
        addBabelPlugin([
    ...
    overrideList.push(addWebpackPlugin(new ReactInspectorPlugin()));
}

module.exports = {
    webpack: override(...overrideList),
