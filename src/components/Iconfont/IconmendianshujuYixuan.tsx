...
const IconmendianshujuYixuan: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
  ...
  return (
    <svg viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} {...rest}>
      ...
      <path
        ...
        fill={getIconColor(color, 1, '#A6A6A6')}
      />
      <path
      ...
      <path
        ...
        fill={getIconColor(color, 3, '#CCCCCC')}
      />
    </svg>
  );
};

IconmendianshujuYixuan.defaultProps = {
  size: 18,
};

export default IconmendianshujuYixuan;
