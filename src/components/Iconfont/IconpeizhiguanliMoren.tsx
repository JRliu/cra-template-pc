...
const IconpeizhiguanliMoren: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
...
IconpeizhiguanliMoren.defaultProps = {
  size: 18,
};

export default IconpeizhiguanliMoren;
