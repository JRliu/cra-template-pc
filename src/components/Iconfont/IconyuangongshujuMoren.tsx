...
const IconyuangongshujuMoren: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
...
IconyuangongshujuMoren.defaultProps = {
  size: 18,
};

export default IconyuangongshujuMoren;
